...
import GradientRecalledEchoExperimentPanel, {
  updatePulses,
} from './GradientRecalledEchoExperimentPanel'
...
function panelProps(
  overrides: Partial<ComponentProps<typeof GradientRecalledEchoExperimentPanel>> = {},
): ComponentProps<typeof GradientRecalledEchoExperimentPanel> {
  return {
    adcAcquisitionRuns: [],
...
describe('GradientRecalledEchoExperimentPanel', () => {
  it('renders all five editable waveforms and the eight PE reference levels', () => {
    const { container } = render(
      <GradientRecalledEchoExperimentPanel {...panelProps()} />,
    )
  ...
  it('routes play, pause, reset, and speed controls by playback status', async () => {
    ...
    const { rerender } = render(
      <GradientRecalledEchoExperimentPanel {...idleProps} />,
    )
    ...
    rerender(<GradientRecalledEchoExperimentPanel {...runningProps} />)
  ...
  it('configures a calibrated center-out acquisition plan when Auto-Fill starts', async () => {
    ...
    render(<GradientRecalledEchoExperimentPanel {...props} />)
  ...
  it('edits a pulse with pointer dragging and shares its timing guide', () => {
    const props = panelProps()
    const { container } = render(
      <GradientRecalledEchoExperimentPanel {...props} />,
    )
