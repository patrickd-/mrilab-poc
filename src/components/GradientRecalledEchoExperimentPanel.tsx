...
interface GradientRecalledEchoExperimentPanelProps {
...
function GradientRecalledEchoExperimentPanel({
  adcAcquisitionRuns,
  adcPulses,
  adcSignalPoints,
  durationMilliseconds,
  ...
  timeMilliseconds,
  transmitFrequencyBand,
}: GradientRecalledEchoExperimentPanelProps) {
...
export default GradientRecalledEchoExperimentPanel
